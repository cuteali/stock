...
ActiveRecord::Schema.define(version: 20170725125015) do
  ...
  create_table "bar_codes", force: :cascade do |t|
    t.integer  "product_id",  limit: 4
    t.string   "bar_code_no", limit: 255
    t.datetime "created_at",              null: false
    t.datetime "updated_at",              null: false
  end

  add_index "bar_codes", ["product_id"], name: "index_bar_codes_on_product_id", using: :btree
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.decimal  "total_cost_price",             precision: 12, scale: 2, default: 0.0
  ...
  create_table "products", force: :cascade do |t|
    ...
    t.integer  "minimum",            limit: 4,                            default: 1
    t.integer  "safe_stock_num",     limit: 4
